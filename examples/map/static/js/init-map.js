...
$(document).bind('stf-ready', function(){
  ...
  $(window).resize(function() {
    ...
    $('input[name="ageRadio"], input[name="yearRadio"], input[name="accidentRadio"], input[name="typeChk"], select[name="insurerSelect"]').change(function() {
        update_premiums();
    });
    ...
    $('.cantons').each(function(i) {
        $(this).mouseenter(function(e) {
        	var toolTipHtml = ""+this.__data__.properties.Name+"<div class=\"test\">"+$(this).data("price")+" CHF</div>";
            $('#tooltip').css({
                       left:  e.pageX + 20,
                       top:   e.pageY - 10
